...
Begin VB.Form main 
   ...
   Begin VB.Frame frmBD 
      ...
      Visible         =   0   'False
      Width           =   2775
      Begin VAccessLib.VAccess VSVarios 
         Left            =   1560
         Top             =   720
         _Version        =   458752
         _ExtentX        =   635
         _ExtentY        =   635
         _StockProps     =   0
         VAccessName     =   "VSVarios"
         TableName       =   "SVARIOS"
         Location        =   "SVARIOS.MKD"
